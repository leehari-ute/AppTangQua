...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeVAT, String productPrice, String cuttedPrice, int productQuantity, int codeSale) {
        this.type = type;
